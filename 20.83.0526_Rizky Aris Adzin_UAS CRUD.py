...
def write_db_api():
	...
	data = response.json()
	cursor = mydb.cursor()
	sql = 'INSERT INTO tbl_students_0526(id,nim,nama,jk,jurusan,alamat) VALUES (%s,%s,%s,%s,%s,%s) '
...
def tampil_data():
	...
	mycursor.execute("SELECT * FROM tbl_students_0526")
...
def tampil_limit():
	...
	mycursor = mydb.cursor()
	sql = ("SELECT * FROM tbl_students_0526 ")
...
def tampilkan_nim():
	...
	mycursor = mydb.cursor()
	sql = ("SELECT * FROM 'tbl_students_0526' WHERE nim=%s" )
