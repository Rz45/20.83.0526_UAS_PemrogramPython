...
--
-- Table structure for table `tbl_students_0526`
--

CREATE TABLE `tbl_students_0526` (
  `id` int(2) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0526`
--

INSERT INTO `tbl_students_0526` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
